...
<form method="GET" class="filter-box">
    <div class="filter-group">
        ...
        <a href="?tanggal=<?= date('Y-m-d') ?>" class="btn-today">Hari Ini</a>
    </div>
</form>
...
<tr class="klik-row" onclick="window.location='detail.php?id=<?= $data['id_pelaporan']; ?>'">
    <td><?= $data['nis']; ?></td>
    ...
    <td>
        <a href="edit.php?id=<?= $data['id_pelaporan']; ?>" 
           class="btn-edit" 
